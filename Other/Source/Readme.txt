...
user in an INI file next to OBSPortable.exe called OBSPortable.ini.
...
copy AppNamePortable.ini from this directory to OBSPortable.ini next to
OBSPortable.exe. The options in the INI file are as follows:
